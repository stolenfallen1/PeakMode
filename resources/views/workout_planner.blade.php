<x-app-layout>
    <div class="px-3" x-data="{
        ...
        saveWorkout() {
            ...
            this.selectedDay.workouts.push({
                ...this.currentWorkout,
                id: Date.now()
            });
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg w-11/12 max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div>
                    ...
                    <div class="flex gap-3 mb-4 pb-3 border-b">
                        <button x-on:click="saveWorkout()" class="flex-1 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
                            Save Workout
                        </button>
                        <button 
            ...
            <div class="space-y-3">
                ...
                <section class="bg-white p-6 rounded shadow-lg">
                    ...
                    <div x-show="selectedDay" class="mt-3">
                        ...
                        <button x-on:click="saveWorkout()" class="mt-3 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                            Save Workout
                        </button>
                    </div>
                </section>
